---
{"dg-publish":true,"permalink":"/czc知识库/5-就业/Python/python学习/2-面向对象/301-面向对象基本思想/","dgPassFrontmatter":true,"created":"2024-11-13T17:14:24.886+08:00","updated":"2024-12-08T12:39:45.356+08:00"}
---
...
②面向对象的思维方式更加贴近现实生活，更容易解决**大型的复杂的业务逻辑**，适合团队开发
③从前期开发的角度来看，面向对象比面向过程要**更复杂**，但是从维护和扩展的角度来看，**面向对象要远比面向过程**
**简单**！
④面向过程的**代码执行效率**比面向对象高（过度封装）
